...
class HIKCamera:
    ...
    def dis(self, nPort, pBuf, nSize, nWidth, nHeight, nStamp, nType, nReserved):
        '''
        显示回调函数
        '''
        print(self)
    ...
    # def get_standard_real_data_callback(self):
    ...
    #
    #
    #     # cb = real_data_callback(self.get_standard_real_data_callback())
    #     return CALLBACK(standard_real_data_callback)
    ...
    def start_preview(self):
        ...
        ccc = real_data_callback(self.standard_real_data_callback)

        self.preview_handle = self.lib.NET_DVR_RealPlay_V40(self.user_id, byref(preview_info), ccc, None)
    ...
    # def get_callback_func(self, f):
    #     real_data_callback = CFUNCTYPE(None, h_LONG, h_DWORD, POINTER(h_BYTE), h_DWORD, h_DWORD)
    #     cb = real_data_callback(self.standard_real_data_callback)
    #     # cb = real_data_callback(self.get_standard_real_data_callback())
    #     return cb
    ...
    def set_real_data_callback(self, f: Callable):
        ...
        # if not self.lib.NET_DVR_SetRealDataCallBack(self.preview_handle, self.get_callback_func(f), h_DWORD(0)):
...
f = DISPLAYCBFUN(partial(HIKCamera.dis, None))
...
if __name__ == '__main__':
    ...
    # camera.set_real_data_callback(cb)
